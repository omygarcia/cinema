			...
			<div class="top-header">
				...
				<div class="search">
					<form action="store" method="get">
						<!--<input type="text" name="txt_buscar" value="Search.." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search..';}"/>-->
						<input type="text" name="txt_buscar" placeholder="Search.."/>
